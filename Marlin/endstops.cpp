...
//	 SERIAL_PROTOCOLPGM("  *** Endstops::update1 ***  ");
  ...
  if (Z_MOVE_TEST) {
    if (stepper.motor_direction(Z_AXIS_HEAD)) { // Z -direction. Gantry down, bed up.
      	//SERIAL_PROTOCOLPGM("  *** -stepper.current_block->steps[Z_AXIS]=  ");
	//SERIAL_PROTOCOL(stepper.current_block->steps[Z_AXIS]);
	//SERIAL_PROTOCOLPGM("  ***  ");
      #if HAS_Z_MIN
        #if ENABLED(Z_DUAL_ENDSTOPS)
...
//SERIAL_PROTOCOLPGM("  *** Endstops::update3 ***  ");
